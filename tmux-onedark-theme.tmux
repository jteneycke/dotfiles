...
set "window-status-current-format" "#[fg=$onedark_black,bg=$green_tab,nobold,nounderscore,noitalics]#[fg=$onedark_visual_grey,bg=$green_tab,nobold] #I  #W #[fg=$green_tab,bg=$onedark_black,nobold,nounderscore,noitalics]"
